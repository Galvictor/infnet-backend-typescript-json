...
@injectable()
export default class LivrosAsyncMongoService implements LivrosAsyncServiceInterface {
    private readonly livroRepositorio: LivroAsyncRepositorioInterface;

    constructor(@inject('LivroAsyncMongoRepositorio') livroRepositorio: LivroAsyncRepositorioInterface) {
